...
import { View, TextInput, Text, Button, Picker, StyleSheet, ScrollView, TouchableHighlight, Keyboard } from 'react-native';
...
class formComplement extends Component { 
    ...
    componentWillMount() {
        console.log('form Complement init bool: ', this.props.bool)
        //console.log('form Complement componentDidMount')
        this.props.modificarBool(false)
        console.log('form Complement bool: ', this.props.bool)
    }

    componentWillReceiveProps(nextProps) {
        //console.log('formComplement componentWillReceiveProps')
    }
